...
\begin{document}
	...
	Operácie nad zásobníkom sú zjednodušené vynechaním napríklad operácie, ktorá by vracala prvok na vrchu zásovníka, keďže táto funkcia nie je potrebná. Naopak bol rozšírený o funkcie ako TODO, ktorá vracia typ najbližšieho tokenu k vrcholu zásobníku alebo o funkciu TODO, ktorá odoberie a vráti všetky neterminály zo zásobníku až po prvý handle, vrátane.
	 ...
	 % Existujú pravidla, pomocí ktorých se
	%redukuje, v poli struktur, kde každá struktura představuje jedno pravidlo.
	%Struktura obahuje prvky pravé strany pravidla vyjádřených pomocí typů tokenů
	%(např. E, ==, E), kde pro Expression je rezervován vyhrazen typ tokenu
	%TT_empty a odkaz na funkci, která toto pravidlo odsimuluje. TODO
	...
	\texttt{LAB} %TODO label - footnote - navestie
