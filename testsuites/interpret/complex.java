...
class string
{
	...
	{
        int ret = ifj16.find(text, pattern);
		return ret;
	}

	static String substr(String text, int pos, int n)
	{
		String ret = ifj16.substr(text, pos, n);
		return ret;
	}

	static int compare(String text, String text2)
	{
		int ret = ifj16.compare(text, text2);
        return ret;
	}
}
...
class system
{
	...
	static String generate(String text, int n)
	{
		...
		string.maxLen = n;
        String ret = string.generator(text);
		return ret;
	}
