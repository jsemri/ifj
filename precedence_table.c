...
T_precedence_state precedence_table[] = {
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_LOWER, PREC_GREATER,
    PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,

    PREC_GREATER, PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_GREATER,
    PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,

    PREC_GREATER, PREC_GREATER, PREC_LOWER, PREC_GREATER, PREC_GREATER,
    PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,

    PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_LOWER, PREC_GREATER,
    PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,

    PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_INVALID,
    PREC_GREATER, PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_LOWER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,
    ...
    PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_GREATER,
    PREC_GREATER, PREC_INVALID, PREC_GREATER, PREC_GREATER, PREC_GREATER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,

    PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_GREATER,
    PREC_GREATER, PREC_GREATER, PREC_INVALID, PREC_GREATER, PREC_GREATER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,

    PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_GREATER,
    PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_INVALID, PREC_GREATER,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,

    PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_LOWER, PREC_GREATER,
    PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_GREATER, PREC_INVALID,
    PREC_LOWER, PREC_GREATER, PREC_LOWER, PREC_GREATER,
